# -*- coding: UTF-8 -*-
"""
@Summary : example1 of state
@Author  : Rey
@Time    : 2022-05-01 18:18:22
"""

from state_machine import (
    State, Event, acts_as_state_machine, after, before, InvalidStateTransition
)
...
class Process:
    ...
    swap_wait = Event(
        from_states=waiting, to_state=swapped_out_waiting
    )
    swap_block = Event(
        from_states=blocked, to_state=swapped_out_blocked
    )
